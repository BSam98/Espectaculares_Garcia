                    ...
                    <form id="form1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="folioi" id="folioi" class="form-control" min="0" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" placeholder="Folio Inicial">
                                    <span class="input-group-addon">-</span>
                                <input type="text" name="foliof" id="foliof" class="form-control" min="0" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" placeholder="Folio Final">
                            </div>
                        </div>
                        <div class="form-group">
