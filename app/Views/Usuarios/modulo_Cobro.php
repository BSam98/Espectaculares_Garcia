...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <!--PUNTO DE VENTA-->
                <div class="container" style="background-color: white;" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="1000" id="puntoVenta"><br>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="card-wrapper col-sm-12 col-md-8 col-lg-8"-->
                            <div class="table table-responsive" style="color: black;"><br>
                                <table>
                                    ...
                                    <tbody id="productos" style="height: 150px; overflow-y: scroll;">
                                        <div id="promos"></div>
                                    </tbody>
                                </table>
                            </div>
    ...
    $(document).on('change', '#promocionn', function(){
        ...
        alert(costo);
            $.ajax({
                ...
                var html =''; var html2 ='';
                html += '<tr>'+
                        '<td colspan="4" style="padding:0px;">'+tarjeta+'</td></tr>'+
                        '<tr style="display:none;" id="recargaa"><td style="padding:0px;">Recarga: </td><td style="padding:0px;"><input type="number" name="precioP" id="precioP" disabled  style="background : inherit; border:none; text-align:center;" class="monto" value='+recarga+'></td><td style="padding:0px;">'+r+'</td></tr>';
                for(var i = 0;i<data.msj.length; i++){
                    html += '<tr><td style="padding:0px;">'+data.msj[i]['Nombre']+'</td>'+
